...
#define DEFAULT_DIMENSION_NONE "None"
...
#define DEFAULT_CROSSFADE_SAMPLE_LENGTH 16384
...
#define ACOREX_MAX_LOG_ENTRIES_STORED (size_t)50
#define ACOREX_MAX_LOG_ENTRIES_DISPLAYED (size_t)10

#define ACOREX_LOG_DISPLAY_SECONDS_TO_FADE_START 6
#define ACOREX_LOG_DISPLAY_SECONDS_WHILE_FADING 4