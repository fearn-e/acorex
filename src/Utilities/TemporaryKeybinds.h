...
#define ACOREX_KEYBIND_LOG_LEVEL_SET_VERBOSE OF_KEY_F1
#define ACOREX_KEYBIND_LOG_LEVEL_SET_NOTICE OF_KEY_F2
#define ACOREX_KEYBIND_LOG_LEVEL_SET_WARNING OF_KEY_F3
#define ACOREX_KEYBIND_LOG_LEVEL_SET_ERROR OF_KEY_F4
#define ACOREX_KEYBIND_LOG_LEVEL_SET_SILENT OF_KEY_F5
